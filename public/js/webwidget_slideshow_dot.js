(function(a){
    a.fn.webwidget_slideshow_dot=function(p){
        ...
        var d=p&&p.directory?p.directory:"imgslide/";
        q += "px";
        r += "px";
        var v;
        var w=-1;
        ...
        function play(){
            ...
            x.find(".title_box").html('<a href="'+x.find(.htm".slides_box").children("ul").children("li").children("a").eq(w).attr("href")+'" style="color:'+stc+'">'+x.find(".slides_box").children("ul").children("li").children("a").eq(w).attr("title")+'</a>');
